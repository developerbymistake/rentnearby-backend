...
public static class DataSeeder
{
    ...
    private static async Task SeedPlansAsync(ApplicationDbContext db)
    {
        ...
        var plans = new[]
        {
            new RoomPlan { Id = Guid.NewGuid(), PlanType = "BASIC", Days = 2, RoomLimit = 1, Price = 99, DiscountPercent = 100, OriginalPrice = 0, IsEnabled = true, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
    ...
    private static async Task SeedPlotPlansAsync(ApplicationDbContext db)
    {
        ...
        var plans = new[]
        {
            new PlotPlan { Id = Guid.NewGuid(), PlanType = "BASIC", Days = 2, PlotListingLimit = 1, Price = 99, DiscountPercent = 100, OriginalPrice = 0, IsEnabled = true, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
