...
namespace RentNearBy.Infrastructure.Migrations
{
    ...
    [Migration("20260725232431_AddDeletedAccountRecords")]
    partial class AddDeletedAccountRecords
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentNearBy.Core.Entities.AppFeatureFlag", b =>
                {
                    ...
                    b.Property<int?>("FreeDurationDays")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RentNearBy.Core.Entities.CreditFeature", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("CreditFeatures");
                });

            modelBuilder.Entity("RentNearBy.Core.Entities.CreditPack", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("RentNearBy.Core.Entities.CreditPackPurchase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex(new[] { "UserId" }, "ix_creditpackpurchases_pending_user")
                        .IsUnique()
                        .HasFilter("\"Status\" = 'PENDING'");

                    b.HasIndex(new[] { "UserId" }, "ix_creditpackpurchases_user");

                    b.ToTable("CreditPackPurchases");
                });

            modelBuilder.Entity("RentNearBy.Core.Entities.CreditPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("RentNearBy.Core.Entities.CreditTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("RentNearBy.Core.Entities.DeletedAccountRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("DeletedAccountRecords");
                });
            ...
            modelBuilder.Entity("RentNearBy.Core.Entities.CreditPackPurchase", b =>
                {
                    b.HasOne("RentNearBy.Core.Entities.CreditPack", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RentNearBy.Core.Entities.PlotPhoto", b =>
                {
                    b.HasOne("RentNearBy.Core.Entities.PlotListing", null)
                        .WithMany("Photos")
            ...
            modelBuilder.Entity("RentNearBy.Core.Entities.RoomPhoto", b =>
                {
                    b.HasOne("RentNearBy.Core.Entities.RoomListing", null)
                        .WithMany("Photos")
