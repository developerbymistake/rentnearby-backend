...
// consumer who submitted the enquiry ("Your enquiry...") vs a co-assigned agent being told about a
...
public record EnquiryStatusPushPayload(Guid RecipientUserId, Guid EnquiryId, string ServiceName, string Status, bool ForAgent = false);
