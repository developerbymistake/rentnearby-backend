...
// Service assignment is a separate full-replace call (SetAgentServicesRequest), not part of create.
...
public record CreateAgentRequest(string Name, string Phone, string WhatsAppNumber, Guid UserId, int? Experience, string? CompanyName);
