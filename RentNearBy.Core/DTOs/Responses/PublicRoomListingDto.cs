...
// redaction logic duplicated here). Deliberately excludes OwnerPhone, UserId, HasReported,
// PendingReportCount, LiveRequestStatus, RejectedReason — none of which belong in an anonymous
// external response (see RoomListingDto, the authenticated counterpart, for the full field set).
